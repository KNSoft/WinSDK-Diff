...
//
// GUID_WDDM_INTERFACE_DISPLAY_CORE {4F4E3ABC-EE6B-4098-B31A-B919B0CAE55F}
//

DEFINE_GUID(GUID_WDDM_INTERFACE_DISPLAY_CORE, 0x4F4E3ABC, 0xEE6B, 0x4098, 0xB3, 0x1A, 0xB9, 0x19, 0xB0, 0xCA, 0xE5, 0x5F);
...
//
// DisplayCore interface
//

#define DXGK_DISPLAY_CORE_INTERFACE_VERSION_1 0x01

typedef _Inout_ DXGK_MONITOR_DESCRIPTOR*  INOUT_DXGK_MONITOR_DESCRIPTOR;

typedef
    _Check_return_
_Function_class_DXGK_(DXGKDDI_QUERY_MONITOR_DESCRIPTOR)
_IRQL_requires_DXGK_(PASSIVE_LEVEL)
NTSTATUS
DXGKDDI_QUERY_MONITOR_DESCRIPTOR(
    IN_CONST_PVOID                          MiniportDeviceContext,
    IN_CONST_D3DDDI_VIDEO_PRESENT_TARGET_ID VideoPresentTargetId,
    INOUT_DXGK_MONITOR_DESCRIPTOR           MonitorDescriptor
    );

typedef DXGKDDI_QUERY_MONITOR_DESCRIPTOR *PDXGKDDI_QUERY_MONITOR_DESCRIPTOR;

typedef struct _DXGK_DISPLAY_CORE_INTERFACE
{
    USHORT Size;
    USHORT Version;
    PVOID Context;
    ...
    PDXGKDDI_QUERY_MONITOR_DESCRIPTOR DxgkDdiQueryMonitorDescriptor;
} DXGK_DISPLAY_CORE_INTERFACE, *PDXGK_DISPLAY_CORE_INTERFACE;
