...
#define FSCTL_REFS_VOLUME_ATTESTATION_BIND_TO_TPM               CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 299, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_REFS_VOLUME_ATTESTATION_QUERY_STATUS              CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 300, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define FSCTL_REFS_VOLUME_ATTESTATION_RESET                     CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 301, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif
...
typedef struct _REFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_INPUT_BUFFER {
...
} REFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_INPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_INPUT_BUFFER;

#define REFS_VOLUME_ATTESTATION_MAX_SIGNING_HASH_SIZE (64)

typedef struct _REFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_OUTPUT_BUFFER {
    ...
    UCHAR SigningHash[REFS_VOLUME_ATTESTATION_MAX_SIGNING_HASH_SIZE];

} REFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_OUTPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_PREPARE_TO_SIGN_OUTPUT_BUFFER;

//
//========== FSCTL_REFS_VOLUME_ATTESTATION_INJECT_CERTIFICATE ==========
//

typedef enum _REFS_VOLUME_ATTESTATION_CERTIFICATE_TYPE {

    REFS_VOLUME_ATTESTATION_CERTIFICATE_TYPE_ASN1_PKCS7_X509_SIGNEDDATA     = 0x00000001,

} REFS_VOLUME_ATTESTATION_CERTIFICATE_TYPE;

typedef struct _REFS_VOLUME_ATTESTATION_INJECT_CERTIFICATE_INPUT_BUFFER {

    ULONG Size;
    ULONG Flags;
    REFS_VOLUME_ATTESTATION_CERTIFICATE_TYPE CertificateType;
    ULONG Reserved[8];
...
} REFS_VOLUME_ATTESTATION_INJECT_CERTIFICATE_INPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_INJECT_CERTIFICATE_INPUT_BUFFER;

//
//========== FSCTL_REFS_VOLUME_ATTESTATION_BIND_TO_TPM ==========
//

typedef enum _REFS_VOLUME_ATTESTATION_BIND_TO_TPM_FLAGS {

    REFS_VOLUME_ATTESTATION_BIND_TO_TPM_FLAG_NO_CERT_REQUIRED = 0x00000001,

} REFS_VOLUME_ATTESTATION_BIND_TO_TPM_FLAGS;

DEFINE_ENUM_FLAG_OPERATORS( REFS_VOLUME_ATTESTATION_BIND_TO_TPM_FLAGS )

typedef struct _REFS_VOLUME_ATTESTATION_BIND_TO_TPM_INPUT_BUFFER {

    ULONG Size;
    REFS_VOLUME_ATTESTATION_BIND_TO_TPM_FLAGS Flags;
...
} REFS_VOLUME_ATTESTATION_BIND_TO_TPM_INPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_BIND_TO_TPM_INPUT_BUFFER;

//
//========== FSCTL_REFS_VOLUME_ATTESTATION_QUERY_STATUS ==========
//

typedef enum _REFS_VOLUME_ATTESTATION_QUERY_STATUS_TYPE {

    REFS_VOLUME_ATTESTATION_QUERY_STATUS_QUERY_SUMMARY                          = 0,
    REFS_VOLUME_ATTESTATION_QUERY_STATUS_QUERY_SIGNATURE                        = 1,
    REFS_VOLUME_ATTESTATION_QUERY_STATUS_QUERY_USER_PAYLOAD                     = 2,
    REFS_VOLUME_ATTESTATION_QUERY_STATUS_QUERY_SUP_INFO                         = 3,

} REFS_VOLUME_ATTESTATION_QUERY_STATUS_TYPE;

typedef enum _REFS_VOLUME_ATTESTATION_ATTESTED_STATE {

    REFS_VOLUME_ATTESTATION_ATTESTED_IS_ATTESTED                  = 0x00000001,
    REFS_VOLUME_ATTESTATION_ATTESTED_WITH_CERTIFICATE             = 0x00000002,
    REFS_VOLUME_ATTESTATION_ATTESTED_WITH_TPM                     = 0x00000004,
    REFS_VOLUME_ATTESTATION_ATTESTED_BROKEN                       = 0x00000008,

} REFS_VOLUME_ATTESTATION_ATTESTED_STATE;

DEFINE_ENUM_FLAG_OPERATORS( REFS_VOLUME_ATTESTATION_ATTESTED_STATE )

typedef struct _REFS_VOLUME_ATTESTATION_QUERY_STATUS_INPUT_BUFFER {

    ULONG Size;
    ULONG Flags;

    REFS_VOLUME_ATTESTATION_QUERY_STATUS_TYPE QueryType;
    ULONG QueryIndex;

    ULONG Reserved[8];

} REFS_VOLUME_ATTESTATION_QUERY_STATUS_INPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_QUERY_STATUS_INPUT_BUFFER;

typedef struct _REFS_VOLUME_ATTESTATION_QUERY_STATUS_OUTPUT_BUFFER {
    ...
    REFS_VOLUME_ATTESTATION_ATTESTED_STATE AttestedState;
    ...
    //
    //  When QueryType is REFS_VOLUME_ATTESTATION_QUERY_STATUS_QUERY_CERTIFICATE
    ...
    //
    //  An internal code indicating why attestation initially failed on this volume.
    //

    USHORT AttestationFailureCode;

    USHORT ReservedShort;
    ULONG Reserved2[5];

} REFS_VOLUME_ATTESTATION_QUERY_STATUS_OUTPUT_BUFFER, *PREFS_VOLUME_ATTESTATION_QUERY_STATUS_OUTPUT_BUFFER;
...
#define TOKEN_LOWBOX                    0x4000 // Deprecate and use TOKEN_APPCONTAINER instead
#define TOKEN_APPCONTAINER              0x4000
...
typedef struct _SE_EXPORTS {
    ...
    //
    // All restricted app packages SID for Less Prvileges AppContainers
    //

    PSID SeAllRestrictedAppPackagesSid;
...
#define QUERY_TYPE_ULONG(TokenInformationClass) (TokenInformationClass == TokenIntegrityLevel        || \
                                                 ...
                                                 TokenInformationClass == TokenIsSystemManagedAdmin  || \
                                                 TokenInformationClass == TokenIsInstaller)
