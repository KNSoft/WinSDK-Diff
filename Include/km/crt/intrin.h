...
__MACHINEARM64(long _InterlockedAnd_lrsc(_Interlocked_operand_ long volatile * _Value, long _Mask))
...
__MACHINEARM64(long _InterlockedOr_lrsc(_Interlocked_operand_ long volatile * _Value, long _Mask))
