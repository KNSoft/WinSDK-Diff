...
typedef enum _IDDFUNCENUM {
    ...
    IddCxAdapterDisplayConfigUpdateForContainerTableIndex = 25,
    IddCxSwapChainInSystemMemoryTableIndex = 26,
    IddCxSwapChainReleaseAndAcquireSystemBufferTableIndex = 27,
    IddCxSwapChainGetPhysicallyContiguousAddressTableIndex = 28,
    IddCxMonitorQueryHardwareCursor2TableIndex = 29,
    IddCxSetRealtimeGPUPriorityTableIndex = 30,
    IddCxSwapChainReleaseAndAcquireBuffer2TableIndex = 31,
    IddCxMonitorQueryHardwareCursor3TableIndex = 32,
    IddCxAdapterDisplayConfigUpdate2TableIndex = 33,
    IddCxMonitorUpdateModes2TableIndex = 34,
    IddCxAdapterDisplayConfigUpdateForContainer2TableIndex = 35,
    IddCxCheckOsFeatureSupportTableIndex = 36,
    IddCxSwapChainSetDevice2TableIndex = 37,
    IddCxSwapChainUpdateStaticDesktopReencodeFrameCountTableIndex = 38,
    IddFunctionTableNumEntries = 39,
} IDDFUNCENUM;
...
typedef enum _IDDSTRUCTENUM {
    ...
    INDEX_IDARG_IN_ADAPTERDISPLAYCONFIGUPDATEFORCONTAINER = 71,
    INDEX_IDDCX_DISPLAYCONFIGPATHFORCONTAINER          = 72,
    INDEX_IDARG_OUT_RELEASEANDACQUIRESYSTEMBUFFER      = 73,
    INDEX_IDDCX_SYSTEM_BUFFER_INFO                     = 74,
    INDEX_IDARG_OUT_QUERY_HWCURSOR2                    = 75,
    INDEX_IDARG_IN_SETREALTIMEGPUPRIORITY              = 76,
    INDEX_IDARG_IN_ADAPTERDISPLAYCONFIGUPDATE2         = 77,
    INDEX_IDARG_IN_ADAPTERDISPLAYCONFIGUPDATEFORCONTAINER2 = 78,
    INDEX_IDARG_IN_COMMITMODES2                        = 79,
    INDEX_IDARG_IN_MONITOR_SET_DEFAULT_HDR_METADATA    = 80,
    INDEX_IDARG_IN_PARSEMONITORDESCRIPTION2            = 81,
    INDEX_IDARG_IN_QUERYTARGET_INFO                    = 82,
    INDEX_IDARG_IN_QUERYTARGETMODES2                   = 83,
    INDEX_IDARG_IN_RELEASEANDACQUIREBUFFER2            = 84,
    INDEX_IDARG_IN_UPDATEMODES2                        = 85,
    INDEX_IDARG_OUT_QUERY_HWCURSOR3                    = 86,
    INDEX_IDARG_OUT_QUERYTARGET_INFO                   = 87,
    INDEX_IDARG_OUT_RELEASEANDACQUIREBUFFER2           = 88,
    INDEX_IDDCX_DISPLAYCONFIG_MODE                     = 89,
    INDEX_IDDCX_DISPLAYCONFIG_MONITOR_COLORIMETRY      = 90,
    INDEX_IDDCX_DISPLAYCONFIGPATH2                     = 91,
    INDEX_IDDCX_DISPLAYCONFIGPATHFORCONTAINER2         = 92,
    INDEX_IDDCX_GAMMARAMP_3X4_COLORSPACE_TRANSFORM     = 93,
    INDEX_IDDCX_GAMMARAMP_RGB256x3x16                  = 94,
    INDEX_IDDCX_HDR10_FRAME_METADATA                   = 95,
    INDEX_IDDCX_HDR10_METADATA                         = 96,
    INDEX_IDDCX_METADATA2                              = 97,
    INDEX_IDDCX_MONITOR_MODE2                          = 98,
    INDEX_IDDCX_PATH2                                  = 99,
    INDEX_IDDCX_RGB                                    = 100,
    INDEX_IDDCX_TARGET_MODE2                           = 101,
    INDEX_IDDCX_WIRE_BITS_PER_COMPONENT                = 102,
    INDEX_IDDCX_WIRE_FORMAT_INFO                       = 103,
    INDEX_IDARG_IN_I2C_TRANSMIT_AND_RECEIVE            = 104,
    INDEX_IDARG_IN_SWAPCHAINSETDEVICE2                 = 105,
    INDEX_IDARG_OUT_FEATURES_SUPPORTED                 = 106,
    IDD_STRUCTURE_TABLE_NUM_ENTRIES                    = 107,
} IDDSTRUCTENUM;
