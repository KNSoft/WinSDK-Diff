...
#define NCI_PACKET_HEADER_GET_PBF(_Header_) \
    (((((PUCHAR)_Header_)[NCI_PACKET_PBF_BUFFER_OFFSET]) & NCI_PACKET_PBF_MASK) >> NCI_PACKET_PBF_SHIFT)

#define NCI_PACKET_CONTROL_GID_BUFFER_OFFSET (0x00)
#define NCI_PACKET_CONTROL_GID_MASK          (0xF)

#define NCI_PACKET_HEADER_GET_CONTROL_GID(_Header_) \
    ((((PUCHAR)_Header_)[NCI_PACKET_CONTROL_GID_BUFFER_OFFSET]) & NCI_PACKET_CONTROL_GID_MASK)

#define NCI_PACKET_CONTROL_OID_BUFFER_OFFSET (0x1)
#define NCI_PACKET_CONTROL_OID_MASK          (0x3F)

#define NCI_PACKET_HEADER_GET_CONTROL_OID(_Header_) \
    ((((PUCHAR)_Header_)[NCI_PACKET_CONTROL_OID_BUFFER_OFFSET]) & NCI_PACKET_CONTROL_OID_MASK)

#define NCI_PACKET_DATA_CONNID_BUFFER_OFFSET (0x00)
#define NCI_PACKET_DATA_CONNID_MASK          (0xF)

#define NCI_PACKET_HEADER_GET_DATA_CONNID(_Header_) \
    ((((PUCHAR)_Header_)[NCI_PACKET_DATA_CONNID_BUFFER_OFFSET]) & NCI_PACKET_DATA_CONNID_MASK)
