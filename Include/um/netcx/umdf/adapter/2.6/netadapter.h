...
// This is temporary; Remove once WDF bring this to their headers
...
typedef enum _NET_RX_FRAGMENT_BUFFER_ALLOCATION_MODE
{
    ...
    // It's the client driver's reponsiblity to so do. Only supported in KMDF
    //
    NetRxFragmentBufferAllocationModeDriver,

    //
    // The operating system never allocates receive fragment buffers.
    // It's the client driver's reponsiblity to so do. This is a more efficient
    // mode supported by both UMDF and KMDF
    //
    NetRxFragmentBufferAllocationModeDriverV2
...
typedef struct _NET_ADAPTER_RX_CAPABILITIES
{
    ...
    union
    {
        ...
        //
        // if AllocationMode is NetRxFragmentBufferAllocationModeDriverV2, the driver
        // must provide a NETMEMORYCOLLECTION object it has used to pre-register memory buffers
        //
        struct
        {
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterPowerOffloadSetArpCapabilities)) {
        ((PFN_NETADAPTERPOWEROFFLOADSETARPCAPABILITIES) NetFunctions[NetAdapterPowerOffloadSetArpCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterPowerOffloadSetArpCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterPowerOffloadSetNSCapabilities)) {
        ((PFN_NETADAPTERPOWEROFFLOADSETNSCAPABILITIES) NetFunctions[NetAdapterPowerOffloadSetNSCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterPowerOffloadSetNSCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterWakeSetBitmapCapabilities)) {
        ((PFN_NETADAPTERWAKESETBITMAPCAPABILITIES) NetFunctions[NetAdapterWakeSetBitmapCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterWakeSetBitmapCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterWakeSetMediaChangeCapabilities)) {
        ((PFN_NETADAPTERWAKESETMEDIACHANGECAPABILITIES) NetFunctions[NetAdapterWakeSetMediaChangeCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterWakeSetMediaChangeCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterWakeSetMagicPacketCapabilities)) {
        ((PFN_NETADAPTERWAKESETMAGICPACKETCAPABILITIES) NetFunctions[NetAdapterWakeSetMagicPacketCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterWakeSetMagicPacketCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterWakeSetEapolPacketCapabilities)) {
        ((PFN_NETADAPTERWAKESETEAPOLPACKETCAPABILITIES) NetFunctions[NetAdapterWakeSetEapolPacketCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterWakeSetEapolPacketCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterWakeSetPacketFilterCapabilities)) {
        ((PFN_NETADAPTERWAKESETPACKETFILTERCAPABILITIES) NetFunctions[NetAdapterWakeSetPacketFilterCapabilitiesTableIndex])(NetDriverGlobals, Adapter, Capabilities);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterWakeSetPacketFilterCapabilitiesTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterReportWakeReasonPacket)) {
        ((PFN_NETADAPTERREPORTWAKEREASONPACKET) NetFunctions[NetAdapterReportWakeReasonPacketTableIndex])(NetDriverGlobals, Adapter, Reason);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterReportWakeReasonPacketTableIndex, FALSE);
    }
#endif
}
...
#else
    if (NET_IS_FUNCTION_AVAILABLE(NetAdapterReportWakeReasonMediaChange)) {
        ((PFN_NETADAPTERREPORTWAKEREASONMEDIACHANGE) NetFunctions[NetAdapterReportWakeReasonMediaChangeTableIndex])(NetDriverGlobals, Adapter, Reason);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NetFrameworkExtensionName, NetAdapterReportWakeReasonMediaChangeTableIndex, FALSE);
    }
#endif
}
