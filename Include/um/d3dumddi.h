...
#if (DXGKDDI_INTERFACE_VERSION >= DXGKDDI_INTERFACE_VERSION_WDDM3_1) || (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_1)
    D3DDDI_QUERYADAPTERTYPE_SINGLEADAPTERHYBRIDMODE = 3,
#endif // (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_1)
    D3DDDI_QUERYADAPTERTYPE_APPLICATIONDESC = 4,
...
typedef enum _D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE
{
    D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE_UNSPECIFIED = 0,      
    D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE_MINIMUM_POWER = 1,    
    D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE_HIGH_PERFORMANCE = 2, 
} D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE;

typedef struct _D3DDDICB_QUERYADAPTERTYPE_DEVICESINGLEADAPTERHYBRIDMODE
{
    D3DDDI_DEVICE_SINGLE_ADAPTER_HYBRID_MODE RequestedHybridConfig; 
} D3DDDICB_QUERYADAPTERTYPE_DEVICESINGLEADAPTERHYBRIDMODE;
...
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_1)

typedef struct _D3DKMT_CREATENATIVEFENCE D3DKMT_CREATENATIVEFENCE;
typedef _Check_return_ HRESULT (APIENTRY CALLBACK *PFND3DDDI_CREATENATIVEFENCECB)(
        _In_ HANDLE hDevice, _Inout_ D3DKMT_CREATENATIVEFENCE*);

#endif // D3D_UMD_INTERFACE_VERSION_WDDM3_1
...
typedef _Check_return_ HRESULT (APIENTRY CALLBACK *PFND3DDDI_QUERYADAPTERINFOCB3)(
        _In_ HANDLE hDevice, _Inout_ CONST D3DDDICB_QUERYADAPTERINFO2*);
#endif
#endif // (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM2_4)
...
#if (D3D_UMD_INTERFACE_VERSION >= D3D_UMD_INTERFACE_VERSION_WDDM3_2)
    HANDLE                         hDevice;            // in: Opaque device handle used for QueryAdapterInfoCB3
#endif
